...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--label_nc', type=int, default=11, help='# of input label classes without unknown class. If you have unknown class as class label, specify --contain_dopntcare_label.')
